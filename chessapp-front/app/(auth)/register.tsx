        ...
        >
          ...
          <View style={styles.hero}>
            <View style={[styles.heroBadge, { backgroundColor: colors.primary }]}>
              <FontAwesome5 name="chess-knight" size={48} color="#fff" />
            </View>
          ...
          <View style={[styles.card, { backgroundColor: colors.card, borderColor: colors.border }]}>
            ...
            <Text style={[styles.label, { color: colors.text, marginTop: 16 }]}>{t.auth.passwordConfirm}</Text>
            <View style={[styles.inputWrapper, { backgroundColor: colors.inputBg, borderColor: colors.border }]}>
              <Ionicons name="lock-closed-outline" size={20} color={colors.textSecondary} style={styles.inputIcon} />
              <TextInput
                style={[styles.input, { color: colors.text }]}
            ...
            >
              {loading
                ...
                : <Text style={[styles.submitText, { color: colors.buttonText }]}>{t.auth.register}</Text>
              }
            </TouchableOpacity>
          </View>
          ...
          <View style={styles.footer}>
            ...
            <Link href="/(auth)/login" replace>
              <Text style={[styles.linkText, { color: colors.primary }]}>{t.auth.login}</Text>
            </Link>
          </View>
        </ScrollView>
      </KeyboardAvoidingView>
