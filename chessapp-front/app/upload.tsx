...
const styles = StyleSheet.create({
  ...
  backContainer: { flexDirection: 'row', alignItems: 'center', alignSelf: 'flex-start', marginBottom: 20 },
  ...
  uploadText: { fontSize: 18, fontWeight: 'bold', textAlign: 'center', marginTop: 15 },

  stepsContainer: { width: '100%', gap: 15 },
  stepBox: {
    width: '100%',
